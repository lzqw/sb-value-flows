...
JOBS = [
    {
        'name': 'scene_task2_R2stableStrong_peak500k_seed2',
        'env': 'visual-scene-play-singletask-task2-v0',
        'domain': 'visual-scene-play',
        'task': 'task2',
        'seed': 2,
        'gpu': 0,
        'steps': 500000,
        'reason': 'scene row weak: task2 existing peak 0.0; 500k best-eval sweep',
    },
    {
        'name': 'scene_task3_R2stableStrong_peak500k_seed2',
        'env': 'visual-scene-play-singletask-task3-v0',
        'domain': 'visual-scene-play',
        'task': 'task3',
        'seed': 2,
        'gpu': 1,
        'steps': 500000,
        'reason': 'scene row weak: task3 existing peak 0.0; 500k best-eval sweep',
    },
]
