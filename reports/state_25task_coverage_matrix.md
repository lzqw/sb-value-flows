...
| cube-double-play | task5 | cube-double-play-singletask-task5-v0 | 0.69 |  |  |  |  |  |  |  |  |  | no_data | Priority 1: no final row; run P0 and R2 300k coverage. |
...
| scene-play | task5 | scene-play-singletask-task5-v0 | 0 |  |  |  |  |  |  |  |  |  | no_data | Priority 1: no final row; run P0 and R2 300k coverage. |
