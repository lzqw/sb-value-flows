...
|---|---|---:|---:|---:|---|---|---:|---:|---|
| P1 immediate 300k screening | puzzle-4x4-play-singletask-task1-v0 | 0.36 | 0.5 |  | No completed 1M result | pending | 2 | 0 | waiting: complete Stage A screening pool first |
...
### 1. stageA_300k puzzle-4x4-play-singletask-task1-v0 R2_residual_disagree_lam0p001 seed2
...
### 2. stageA_300k puzzle-4x4-play-singletask-task1-v0 R3_residual_disagree_typicality_lam0p001 seed2
...
### 3. stageA_300k puzzle-4x4-play-singletask-task3-v0 P0_particle seed2
...
### 4. stageA_300k puzzle-4x4-play-singletask-task3-v0 MinimalSB_lam0p003 seed2
...
### 5. stageA_300k puzzle-4x4-play-singletask-task3-v0 MinimalSB_lam0p001 seed2
...
### 6. stageA_300k puzzle-4x4-play-singletask-task3-v0 A1_action_std_lam0p001 seed2
...
### 7. stageA_300k puzzle-4x4-play-singletask-task3-v0 A2_action_std_lam0p003 seed2
...
### 8. stageA_300k puzzle-4x4-play-singletask-task3-v0 R2_residual_disagree_lam0p001 seed2
...
### 9. stageA_300k puzzle-4x4-play-singletask-task3-v0 R3_residual_disagree_typicality_lam0p001 seed2
...
### 10. stageA_300k puzzle-3x3-play-singletask-task5-v0 P0_particle seed2
...
- candidate tasks: 9
- skipped tasks: 16
- pending Stage A runs: 16
- pending Stage B runs: 1
- total pending runs: 17
