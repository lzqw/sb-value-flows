...
|---|---|---:|---:|---:|---|---|---:|---:|---|
| P1 immediate 300k screening | puzzle-4x4-play-singletask-task1-v0 | 0.36 | 0.5 |  | No completed 1M result | pending | 0 | 6 |  |
| P1 immediate 300k screening | puzzle-4x4-play-singletask-task3-v0 | 0.3 | 0.2 |  | No completed 1M result | pending | 6 | 0 | waiting: complete Stage A screening pool first |
...
| env | config | seed | target_steps | reason |
|---|---|---:|---:|---|
| puzzle-4x4-play-singletask-task1-v0 | P0_particle | 0 | 1000000 | selected top Stage A config for 1M confirmation |
| puzzle-4x4-play-singletask-task1-v0 | P0_particle | 1 | 1000000 | selected top Stage A config for 1M confirmation |
| puzzle-4x4-play-singletask-task1-v0 | P0_particle | 2 | 1000000 | selected top Stage A config for 1M confirmation |
| puzzle-4x4-play-singletask-task1-v0 | A2_action_std_lam0p003 | 0 | 1000000 | selected top Stage A config for 1M confirmation |
| puzzle-4x4-play-singletask-task1-v0 | A2_action_std_lam0p003 | 1 | 1000000 | selected top Stage A config for 1M confirmation |
| puzzle-4x4-play-singletask-task1-v0 | A2_action_std_lam0p003 | 2 | 1000000 | selected top Stage A config for 1M confirmation |
...
### 1. stageA_300k puzzle-4x4-play-singletask-task3-v0 MinimalSB_lam0p003 seed2
...
### 2. stageA_300k puzzle-4x4-play-singletask-task3-v0 MinimalSB_lam0p001 seed2
...
### 3. stageA_300k puzzle-4x4-play-singletask-task3-v0 A1_action_std_lam0p001 seed2
...
### 4. stageA_300k puzzle-4x4-play-singletask-task3-v0 A2_action_std_lam0p003 seed2
...
### 5. stageA_300k puzzle-4x4-play-singletask-task3-v0 R2_residual_disagree_lam0p001 seed2
...
### 6. stageA_300k puzzle-4x4-play-singletask-task3-v0 R3_residual_disagree_typicality_lam0p001 seed2
...
### 7. stageA_300k puzzle-3x3-play-singletask-task5-v0 P0_particle seed2

```bash
CUDA_VISIBLE_DEVICES=0 MUJOCO_GL=egl PYOPENGL_PLATFORM=egl SDL_VIDEODRIVER=dummy OGBENCH_DATA_DIR=/root/.ogbench/data XDG_CACHE_HOME=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/cache XLA_PYTHON_CLIENT_PREALLOCATE=true XLA_PYTHON_CLIENT_MEM_FRACTION=0.90 /root/miniconda3/bin/conda run -n value-flows python main.py --env_name=puzzle-3x3-play-singletask-task5-v0 --seed=2 --save_dir=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/exp --wandb_run_group=stageA_300k_puzzle_3x3_task5_P0_particle_seed2 --enable_wandb=0 --offline_steps=300000 --online_steps=0 --eval_interval=50000 --eval_episodes=10 --log_interval=25000 --save_interval=999999999 --agent=agents/pm_value_flows.py --agent.bcfm_lambda=0.5 --agent.ret_agg=min --agent.pm_minimal_sb=true --agent.pm_weight_type=field_kernel_norm --agent.pm_num_continuations=4 --agent.pm_field_kernel_norm_temp=0.3 --agent.pm_field_kernel_min_scale=1e-6 --agent.pm_actor_energy_coef=0.0 --agent.pm_actor_disagree_coef=0.0 --agent.pm_log_sb_diagnostics=true --agent.pm_sb_reliability_score=action --agent.pm_sb_lambda=0.0 --agent.pm_sb_reliability_normalize=none --agent.pm_sb_value_preserving=false
```

### 8. stageA_300k puzzle-3x3-play-singletask-task5-v0 MinimalSB_lam0p003 seed2

```bash
CUDA_VISIBLE_DEVICES=0 MUJOCO_GL=egl PYOPENGL_PLATFORM=egl SDL_VIDEODRIVER=dummy OGBENCH_DATA_DIR=/root/.ogbench/data XDG_CACHE_HOME=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/cache XLA_PYTHON_CLIENT_PREALLOCATE=true XLA_PYTHON_CLIENT_MEM_FRACTION=0.90 /root/miniconda3/bin/conda run -n value-flows python main.py --env_name=puzzle-3x3-play-singletask-task5-v0 --seed=2 --save_dir=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/exp --wandb_run_group=stageA_300k_puzzle_3x3_task5_MinimalSB_lam0p003_seed2 --enable_wandb=0 --offline_steps=300000 --online_steps=0 --eval_interval=50000 --eval_episodes=10 --log_interval=25000 --save_interval=999999999 --agent=agents/pm_value_flows.py --agent.bcfm_lambda=0.5 --agent.ret_agg=min --agent.pm_minimal_sb=true --agent.pm_weight_type=field_kernel_norm --agent.pm_num_continuations=4 --agent.pm_field_kernel_norm_temp=0.3 --agent.pm_field_kernel_min_scale=1e-6 --agent.pm_actor_energy_coef=0.0 --agent.pm_actor_disagree_coef=0.0 --agent.pm_log_sb_diagnostics=true --agent.pm_sb_reliability_score=action --agent.pm_sb_lambda=0.003 --agent.pm_sb_reliability_normalize=none --agent.pm_sb_value_preserving=false
```

### 9. stageA_300k puzzle-3x3-play-singletask-task5-v0 MinimalSB_lam0p001 seed2

```bash
CUDA_VISIBLE_DEVICES=0 MUJOCO_GL=egl PYOPENGL_PLATFORM=egl SDL_VIDEODRIVER=dummy OGBENCH_DATA_DIR=/root/.ogbench/data XDG_CACHE_HOME=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/cache XLA_PYTHON_CLIENT_PREALLOCATE=true XLA_PYTHON_CLIENT_MEM_FRACTION=0.90 /root/miniconda3/bin/conda run -n value-flows python main.py --env_name=puzzle-3x3-play-singletask-task5-v0 --seed=2 --save_dir=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/exp --wandb_run_group=stageA_300k_puzzle_3x3_task5_MinimalSB_lam0p001_seed2 --enable_wandb=0 --offline_steps=300000 --online_steps=0 --eval_interval=50000 --eval_episodes=10 --log_interval=25000 --save_interval=999999999 --agent=agents/pm_value_flows.py --agent.bcfm_lambda=0.5 --agent.ret_agg=min --agent.pm_minimal_sb=true --agent.pm_weight_type=field_kernel_norm --agent.pm_num_continuations=4 --agent.pm_field_kernel_norm_temp=0.3 --agent.pm_field_kernel_min_scale=1e-6 --agent.pm_actor_energy_coef=0.0 --agent.pm_actor_disagree_coef=0.0 --agent.pm_log_sb_diagnostics=true --agent.pm_sb_reliability_score=action --agent.pm_sb_lambda=0.001 --agent.pm_sb_reliability_normalize=none --agent.pm_sb_value_preserving=false
```

### 10. stageA_300k puzzle-3x3-play-singletask-task5-v0 A1_action_std_lam0p001 seed2

```bash
CUDA_VISIBLE_DEVICES=0 MUJOCO_GL=egl PYOPENGL_PLATFORM=egl SDL_VIDEODRIVER=dummy OGBENCH_DATA_DIR=/root/.ogbench/data XDG_CACHE_HOME=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/cache XLA_PYTHON_CLIENT_PREALLOCATE=true XLA_PYTHON_CLIENT_MEM_FRACTION=0.90 /root/miniconda3/bin/conda run -n value-flows python main.py --env_name=puzzle-3x3-play-singletask-task5-v0 --seed=2 --save_dir=/root/autodl-tmp/sb-value-flows-runs/selective_state_tuning_single4090/exp --wandb_run_group=stageA_300k_puzzle_3x3_task5_A1_action_std_lam0p001_seed2 --enable_wandb=0 --offline_steps=300000 --online_steps=0 --eval_interval=50000 --eval_episodes=10 --log_interval=25000 --save_interval=999999999 --agent=agents/pm_value_flows.py --agent.bcfm_lambda=0.5 --agent.ret_agg=min --agent.pm_minimal_sb=true --agent.pm_weight_type=field_kernel_norm --agent.pm_num_continuations=4 --agent.pm_field_kernel_norm_temp=0.3 --agent.pm_field_kernel_min_scale=1e-6 --agent.pm_actor_energy_coef=0.0 --agent.pm_actor_disagree_coef=0.0 --agent.pm_log_sb_diagnostics=true --agent.pm_sb_reliability_score=action --agent.pm_sb_lambda=0.001 --agent.pm_sb_reliability_normalize=std --agent.pm_sb_value_preserving=false
```
...
- candidate tasks: 9
- skipped tasks: 16
- pending Stage A runs: 13
- pending Stage B runs: 7
- total pending runs: 20
...
AM reports/puzzle3x3_bestseed_5task_single4090_v3_report.md
 ...
 M results/eval_curves_index.csv
