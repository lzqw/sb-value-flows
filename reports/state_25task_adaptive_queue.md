...
| 5 | 2 | cube-triple-play-singletask-task1-v0 | cube-triple-play | task1 | state_stable_v1_diagnostic | ActorGeo | 0 | 300000 | best/peak high but final row dropped; do not use peak as final | true | state_stable_v1 flags not implemented in current code |
| 6 | 2 | puzzle-4x4-play-singletask-task3-v0 | puzzle-4x4-play | task3 | state_stable_v1_diagnostic | R2_residual_disagree_lam0p001 | 2 | 300000 | best/peak high but final row dropped; do not use peak as final | true | state_stable_v1 flags not implemented in current code |
| 7 | 2 | scene-play-singletask-task4-v0 | scene-play | task4 | state_stable_v1_diagnostic | P0_particle | 2 | 300000 | best/peak high but final row dropped; do not use peak as final | true | state_stable_v1 flags not implemented in current code |
